		...
		<view>
			...
			<view class="view_center" style="flex-direction: column;">
				<view style="margin: 10rpx 0;">
					<uni-combox label="月份" :candidates="months" placeholder="请选择月份" v-model="month" @input="month_change"></uni-combox>
				</view>
				<view style="margin: 10rpx 0;">
					<uni-combox label="日期" :candidates="days" placeholder="请选择日期" v-model="day" @input="day_change"></uni-combox>
				</view>
			</view>
